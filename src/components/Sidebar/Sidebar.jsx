          ...
          <div className="menu">
            <ul className="menu-links">
              <li className="nav-link" onClick={() => setMainPage("home")}>
                <a href="#">
                  <FontAwesomeIcon icon={faFileLines} className="menu-icons" />
      ...
      >
        ...
        >
          ...
          <span
            ...
            style={{
              borderBottom: activeSection === "outline" && "3px solid #126fd6",
          ...
          <span
            ...
            style={{
              borderBottom: activeSection === "comments" && "3px solid #126fd6",
